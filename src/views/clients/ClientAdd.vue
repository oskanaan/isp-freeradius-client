<template>
  <GenericOperation
      ref="genericOperationRef"
      :title="this.$t(`clientAdd`)"
      :fields="clientFields"
      :endpoint="endpoint"
      :addLabel="this.$t(`add`)"
...
export default {
  ...
  mounted() {
    this.$refs.genericOperationRef.entity.latitude = localStorage.getItem("defaultLatitude")
    this.$refs.genericOperationRef.entity.longitude = localStorage.getItem("defaultLongitude")
  },
  methods: {
